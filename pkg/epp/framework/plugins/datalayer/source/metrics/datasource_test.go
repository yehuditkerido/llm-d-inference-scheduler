...
func TestMetricsDataSourceFactory_TLS(t *testing.T) {
	tests := []struct {
		...
		{name: "client cert wired to loader", params: `{"scheme":"https","clientCertPath":"/nope/c.pem","clientKeyPath":"/nope/k.pem"}`, wantErr: "loading client cert"},
		{name: "ca path wired to loader", params: `{"scheme":"https","caCertPath":"/nope/ca.pem"}`, wantErr: "reading CA cert"},
	}
